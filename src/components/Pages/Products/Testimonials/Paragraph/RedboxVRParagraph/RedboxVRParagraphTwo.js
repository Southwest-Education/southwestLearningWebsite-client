  ...
  return (
    <div>
      <p className='ReadingPlusParagraph'>
        ...
        from dealing with the financials aspects and ending up with the details
        around installing and running the system. Happy customer, but more
        important - super happy children and professors!"
        <br /> Parent
      </p>
    </div>
  );
...
export default RedboxVRParagraphTwo;
