  ...
  return (
    <div>
      <p className='ReadingPlusParagraph'>
        ...
        students Prairie Lea received a “B” rating.  Not only did they meet
        standard in all areas but they received a distinction in Reading! Great
        Job Prairie Lea!"
        <br /> Larry Markert, Superintendent
      </p>
    </div>
  );
};
